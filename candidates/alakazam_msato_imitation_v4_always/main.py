...
# High-variance lottery arm: the blind-test semantic fidelity of the learned
# scorer exceeded the parent even outside the conservative gate.  Let it own
# every legal MAIN choice so native H2H can directly test closed-loop behavior.
_MINIMUM_SUPPORT = 0
_MINIMUM_MARGIN = -1.0e30
