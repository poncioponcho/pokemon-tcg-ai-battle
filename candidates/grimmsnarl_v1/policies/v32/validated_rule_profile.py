...
BUILD_ID = "ptcg_fixed_deck_expert_manual_protocol_hierarchical_policy_v32"
...
# v27: single-Snorunt Poffin completion.
# The prior profile intentionally declined an optional Poffin choice when only
# Snorunt remained.  Repeated visible states show that the target takes that
# Snorunt when no Froslass line exists and a bench slot is open.
